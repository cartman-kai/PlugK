...
#define X(type, name, sec, key, val, desc)                                                                                                                                                                                                                               \
    ...
    {                                                                                                                                                                                                                                                                    \
        ...
        {                                                                                                                                                                                                                                                                \
            ...
            if ((strcmp("fps_limit", #name) == 0))                                                                                                                                                                                                                       \
            {                                                                                                                                                                                                                                                            \
                if (g_pk_config.name < -1)                                                                                                                                                                                                                               \
                    g_pk_config.name = -1;                                                                                                                                                                                                                               \
                if (g_pk_config.name > 400)                                                                                                                                                                                                                              \
                    g_pk_config.name = 400;                                                                                                                                                                                                                              \
            }                                                                                                                                                                                                                                                            \
        }                                                                                                                                                                                                                                                                \
        ...
        {                                                                                                                                                                                                                                                                \
            ...
            {                                                                                                                                                                                                                                                            \
                if ((strcmp("key_hold_show_item_name", #name) == 0))                                                                                                                                                                                                     \
                    ImGui::SetTooltip("按住 %s 时显示地面物品名称", KeyCodeToString(k).c_str());                                                                                                                                                                          \
                else                                                                                                                                                                                                                                                     \
